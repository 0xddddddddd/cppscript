...
void MD5::update_file(FILE* file) {
...
std::string MD5::raw_digest() {
	...
	std::string ret;
	ret.append((char*)digest, 16);
    return ret;
}

std::string MD5::hex_digest16() {

	std::string ret = hex_digest();
	return ret.substr(8, 16);
}
